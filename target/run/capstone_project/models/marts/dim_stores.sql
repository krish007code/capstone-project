    ...
    create  table
      "capstone_dev"."main"."dim_stores__dbt_tmp"
...
select * from joined
),  __dbt__cte__int_store_costs_aggregated as (
...
select * from store_aggregates
    ...
    select * from "capstone_dev"."main"."stg_stores"
),
store_financials as (
    select * from __dbt__cte__int_store_costs_aggregated
),
final as (
    select
        stores.store_id,
